...
install:
    ...
    # install
    @gksu apt-get install python-webkit python-simplejson
	...
	# open web browser
	@xdg-open "https://www.facebook.com/dialog/oauth?client_id=cf61e1494a431f7db3c8372cc4a17bdf&redirect_uri=https://www.facebook.com/connect/login_success.html&response_type=token&scope=read_mailbox,read_requests,offline_access,manage_notifications,user_photos,user_activities,user_likes"
